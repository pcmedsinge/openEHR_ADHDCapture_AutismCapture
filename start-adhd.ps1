...
Write-Host "  ADHDCapture — Module 3 Startup" -ForegroundColor White
Write-Host "══════════════════════════════════════════════" -ForegroundColor DarkBlue
Write-Host ""
...
$port5434 = Get-NetTCPConnection -LocalPort 5434 -ErrorAction SilentlyContinue
...
Write-Step "Starting ADHDCapture frontend..."
Start-Process powershell -ArgumentList @(
    "-NoExit",
    "-Command",
    "Write-Host 'ADHDCapture frontend' -ForegroundColor Cyan; Set-Location '$FRONTEND_DIR'; npm run dev"
)
...
Write-Host "══════════════════════════════════════════════" -ForegroundColor DarkGreen
Write-Host ""
Write-Host "  ADHDCapture UI   → http://localhost:5173" -ForegroundColor White
...
Write-Host ""
Write-Host "  To stop:  .\stop-adhd.ps1  or  docker-compose down" -ForegroundColor DarkGray
Write-Host ""
